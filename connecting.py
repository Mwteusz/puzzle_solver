...
from puzzle_extracting import ExtractedPuzzle
...
def get_mask_xor_ratio(puzzle1, edge_type1, puzzle2, edge_type2) -> (float, np.ndarray):
    ...
    place_image_in_image(output_img, puzzle1.mask, (output_img.shape[1] // 2 - connection_point1[0], output_img.shape[0] // 2 - connection_point1[1]))
    place_image_in_image(output_img, puzzle2.mask, (output_img.shape[1] // 2 - connection_point2[0], output_img.shape[0] // 2 - connection_point2[1]))
...
def test_connect_puzzles(piece_indexes, edges):
    puzzle1 = create_puzzle(f"extracted/processed_photo_{piece_indexes[0]}.png")
    puzzle2 = create_puzzle(f"extracted/processed_photo_{piece_indexes[1]}.png")
    edge1, edge2 = edges
